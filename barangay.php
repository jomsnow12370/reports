...
function count_leaders($c, $leader_type, $mun, $bgry) {
...
function count_survey_responses($c, $mun, $brgy, $remarks_txt, $is_household_head = true) {
...
// Get leader counts
$total_mc = count_leaders($c, 4, $mun, $brgy);
$total_dc = count_leaders($c, 3, $mun, $brgy);
$total_bc = count_leaders($c, 2, $mun, $brgy);
$total_wl = count_leaders($c, 1, $mun, $brgy);
...
foreach ($gov_candidates as $candidate) {
    $remarks = $candidate . '(Survey 2025)';
    $head_count = count_survey_responses($c, $mun, $brgy, $remarks, true);
    $member_count = count_survey_responses($c, $mun,$brgy,  $remarks, false);
