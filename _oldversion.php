...
(SELECT CASE 
        ...
        END 
         FROM wardingtbl 
         WHERE member_v_id = v_info.v_id AND 
       ) AS wardingCheck,
...
(SELECT CASE 
        ...
        END 
         FROM head_household 
         WHERE fh_v_id = v_info.v_id) AS headHouseholdCheck,
...
(SELECT CASE 
        ...
        END 
         ...
         WHERE  mem_v_id = v_info.v_id) AS memberCheck,
...
(SELECT CASE 
        ...
        END 
         FROM v_remarks 
         INNER JOIN quick_remarks ON quick_remarks.remarks_id = v_remarks.remarks_id 
         WHERE v_remarks.v_id = v_info.v_id AND candidate = 1) AS laynesCheck,
        ...
        END 
         FROM v_remarks 
         INNER JOIN quick_remarks ON quick_remarks.remarks_id = v_remarks.remarks_id 
         WHERE v_remarks.v_id = v_info.v_id AND AND candidate = 3) AS rodriguezCheck,
        ...
        END 
         FROM v_remarks 
         INNER JOIN quick_remarks ON quick_remarks.remarks_id = v_remarks.remarks_id 
         WHERE v_remarks.v_id = v_info.v_id AND candidate = 3) AS albertoCheck,
...
AND record_type = 1 ORDER BY barangayId, v_lname, v_fname LIMIT 1";
